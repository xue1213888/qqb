...
var eventParseFuncMap = map[dto.OPCode]map[dto.EventType]eventParseFunc{
	dto.WSDispatchEvent: {
		...
		dto.EventOpenForumThreadCreate: openThreadHandler,
		dto.EventOpenForumThreadUpdate: openThreadHandler,
		dto.EventOpenForumThreadDelete: openThreadHandler,
		dto.EventOpenForumPostCreate:   openPostHandler,
		dto.EventOpenForumPostDelete:   openPostHandler,
		dto.EventOpenForumReplyCreate:  openReplyHandler,
		dto.EventOpenForumReplyDelete:  openReplyHandler,
		dto.EventForumAuditResult:      forumAuditHandler,

		dto.EventInteractionCreate: interactionHandler,

		dto.EventAudioOrLiveChannelMemberEnter: audioOrLiveChannelMemberHandler,
		dto.EventAudioOrLiveChannelMemberExit:  audioOrLiveChannelMemberHandler,
...
func qqFriendAdd(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQFriendAddData{}
...
func qqC2cMsgReject(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQC2cMsgRejectData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqC2cMsgReceive(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQC2cMsgReceiveData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqGroupAddRobot(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQGroupAddRobotData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqGroupDelRobot(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQGroupDelRobotData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqGroupMsgReject(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQGroupMsgRejectData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqGroupMsgReceive(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQGroupMsgReceiveData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
...
func qqC2cMessageCreate(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQC2cMessageCreateData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.C2cMessageCreate != nil {
		return DefaultHandlers.C2cMessageCreate(payload, data)
	}
	return nil
}

func qqGroupAtMessageCreate(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSQQGroupAtMessageCreateData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.GroupAtMessageCreate != nil {
		return DefaultHandlers.GroupAtMessageCreate(payload, data)
	}
	return nil
}
...
func audioOrLiveChannelMemberHandler(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSAudioOrLiveChannelMemberData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.Audio != nil {
		return DefaultHandlers.AudioOrLiveChannelMember(payload, data)
	}
	return nil
}
...
func openThreadHandler(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSThreadData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.OpenThread != nil {
		return DefaultHandlers.OpenThread(payload, data)
	}
	return nil
}

func openPostHandler(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSPostData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.OpenPost != nil {
		return DefaultHandlers.OpenPost(payload, data)
	}
	return nil
}

func openReplyHandler(payload *dto.WSPayload, message []byte) error {
	data := &dto.WSReplyData{}
	if err := ParseData(message, data); err != nil {
		return err
	}
	if DefaultHandlers.OpenReply != nil {
		return DefaultHandlers.OpenReply(payload, data)
	}
	return nil
}
